...
export default function AdViewTestStatus() {
  ...
  const defaultAdData = [
    ...
    },
    {
      ...
      fields: {
        ...
        imageUrl:
          'https://www.atacadoaesportiva.com.br/wp-content/uploads/2019/01/banner-250x250.jpg',
        width: 250,
        height: 250,
      },
    },
    ...
    <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div className="test-section">
        {testResults.import ? (
          <div>
            ...
            <p>
              <strong>Message:</strong> {testResults.import.message}
            </p>
          ...
          <div className="test-grid">
            <div className="test-card">
              ...
              <div className="ad-container">
                <AdView.Unit
                  unitId="2ow6OsRrQDts2X5jiyZ2mhWQF6f"
                  format="banner"
                >
                            ...
                            >
                              <span
                                style={{
                                  ...
                                  textAlign: 'center',
                                  textShadow:
                                    '0 2px 8px rgba(0,0,0,0.8), 0 1px 2px rgba(0,0,0,0.7)',
                                  lineHeight: 1.2,
                                  background: 'none',
                                  padding: '0.5rem 1rem',
            ...
            <div className="test-card">
              ...
              <div className="ad-container">
                <AdView.Unit
                  unitId="2ow6OsRrQDts2X5jiyZ2mhWQF6x"
                  format="nothing"
                >
            ...
            <div className="test-card">
              ...
              <div className="ad-container">
                <AdView.Unit
                  unitId="2ow6OsRrQDts2X5jiyZ2mhWQF6g"
                  format="native"
                >
                  {({ data, state, error }) => (
                    <div
      ...
      <div className="test-section">
        ...
        <div className="code-block">
          ...
          <div>
            <strong>Package Location:</strong> file:../packages/react
          </div>
          <div>
            <strong>Test Server:</strong> http://localhost:3002
          </div>
          <div>
